...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    const res = await fetch("/api/auth/signup", {
      ...
      body: JSON.stringify({ firstName, lastName, idNumber, dateJoined, email, password }),
    });
    ...
    <div className={styles.container}>
      ...
      <form onSubmit={handleSignup} className={styles.form}>
        ...
        <div className={`${styles.inputGroup} ${styles.passwordContainer}`}>
          ...
          <input type={showConfirmPassword ? "text" : "password"} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required className={styles.input} />
        ...
        <button type="submit" disabled={!allValid || !passwordsMatch} className={styles.button}>
          Sign Up
        </button>
